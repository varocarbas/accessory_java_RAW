...
public abstract class keys 
{
	...
	public static final String DB = types.what_to_key(types.WHAT_DB);
	public static final String HOST = types.what_to_key(types.WHAT_HOST);
	...
	public static final String FILE = types.what_to_key(types.WHAT_FILE);
	public static final String SCREEN = types.what_to_key(types.WHAT_SCREEN);
	...
	public static final String APP = types.what_to_key(types.WHAT_APP);
	public static final String DIR = types.what_to_key(types.WHAT_DIR);
	public static final String SERVER = types.what_to_key(types.WHAT_SERVER);
