...
{	
	...
	public static void start(boolean includes_legacy_) { _instance.populate_all(includes_legacy_); }
	...
	public static void start(String dbs_user_, String dbs_host_, boolean dbs_encrypted_, boolean includes_legacy_) { _instance.populate_all(dbs_user_, null, null, dbs_host_, dbs_encrypted_, includes_legacy_); }
	...
	public static void start(String dbs_username_, String dbs_password_, String dbs_host_, boolean includes_legacy_)  { _instance.populate_all(null, dbs_username_, dbs_password_, dbs_host_, false, includes_legacy_); }
}